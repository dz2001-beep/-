...
# 加载数据集
crime_counts = np.load("data/crime_counts.npy", allow_pickle=True)
check_counts = np.load("data/check_counts.npy", allow_pickle=True)
with open("data/mh_cd.json", 'r') as f:
    mh_cd = json.load(f)
